...
<body>
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading"><a class="btn btn-primary" role="button" href="10questioninfo.php?qid=0"><strong>+ Add New Question</strong></a></div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group"><a class="btn btn-primary" href="10questioninfo.php?qid=<?php echo $row["QID"]; ?>">Edit Question</a>
                                    <a class="btn btn-warning" href="10questions.php?delete=<?php echo $row["QID"];?>" type="button">Delete</a></div>
                            </td>
                        </tr><?php } ?>
                    </tbody>
                </table>
