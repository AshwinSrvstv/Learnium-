...
if(isset($_POST["QID"]))
{
    ...
    if($QID=="0")
    {
        $db->NonQuery("INSERT INTO `questions`(`Question`,`Option1`,`Option2`,`Option3`,`Option4`,`CorrectAnswer`,`Category`) Values('".$Question."','".$Option1."','".$Option2."','".$Option3."','".$Option4."','".$CorrectAnswer."','".$Category."');");
        ...
        header("location: 12questions.php");return;
    }
    else
    {
...
$CategoryList= SelectOptionsFormArray(array("Engineering","Medical","Management","Civil"),$Category);
